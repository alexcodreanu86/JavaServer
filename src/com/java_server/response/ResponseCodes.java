...
public class ResponseCodes {
    private static final Hashtable<String, String> HttpReplies =new Hashtable<String, String>(){{
            put("100", "Continue");
    ...
    public static String getReasonPhrase(String code) {
       return HttpReplies.get(code);
    }
